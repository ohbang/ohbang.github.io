...
;(function ($, window, document, undefined) {
  ...
  function Plugin(element, options) {
    ...
    this.currentDate.setFullYear(2020);
    this.currentDate.setMonth(9);
    this.currentDate.setDate(11);
    this.init();
  }
  ...
  $.extend(Plugin.prototype, {
    ...
    buildCalendar: function (fromDate, calendar) {
      ...
      // wedding day
      var weddingDay = new Date(2020, 9, 11);
      ...
      for (var day = firstDay; day <= lastDay; day.setDate(day.getDate())) {
        ...
        for (var i = 0; i < 7; i++) {
          ...
          if (day.toDateString() === weddingDay.toDateString()) {
            $day.addClass("today");
          }
